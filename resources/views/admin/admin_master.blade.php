                ...
                <ul class="nav navbar-nav">
                  ...
                  <li class="dropdown user-menu">
                    <button href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                      <img src="{{ Auth::user()->profile_photo_url }}" class="user-image img-circle" alt="User Image" />
                      <span class="d-none d-lg-inline-block">{{Auth::user()->name}}</span>
                    </button>
                    <ul class="dropdown-menu dropdown-menu-right">
                      <!-- User image -->
                      <li class="dropdown-header">
                        <img src="{{ Auth::user()->profile_photo_url }}" alt="User image" class="img-circle" />
                      ...
                      <li>
                        <a href="{{route('show.messages')}}">
                          <i class="mdi mdi-email"></i> Client Messages
                        </a>
                      </li>
                      <li>
                      ...
                      <li>
                        <a href="{{route('admin.profile')}}"> <i class="mdi mdi-settings"></i> Account Setting </a>
                      </li>

                      <li class="dropdown-footer">
                        <a href="{{route('admin.logout')}}" onclick="return confirm('Are you sure to logout?')"> <i class="mdi mdi-logout"></i> Log Out </a>
                      </li>
                    </ul>
                  </li>
                </ul>
        ...
        <div class="content-wrapper">
          <div class="content">						 
            ...
            <div class="copyright bg-white">
              <p>
                &copy; <span id="copy-year">2021</span> Copyright Programmingster
